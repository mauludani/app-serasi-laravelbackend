...
class DaftarBayarPages extends StatefulWidget {
  @override
  _DaftarBayarPagesState createState() => _DaftarBayarPagesState();
}

class _DaftarBayarPagesState extends State<DaftarBayarPages> {
